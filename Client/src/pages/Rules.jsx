    ...
    <div className="rules bg-cover bg-center h-screen p-4" style={{ backgroundImage: 'url("../../public/portalbgdark.jpg")'}}>
      ...
      <div className='rulesInfo bg-gray-100 rounded-md m-10 p-4 flex flex-col'>
        ...
        <ul className='rulesData leading-9 tracking-wide text-2xl list-decimal m-12'>
            <li>Register yourself on the QRIOSITY website to access the questions using JUIT Solan Email ID only.</li>
            ...
            <li>6 hours will be allotted (starting at 4 PM, 23/01/2022) to complete the whole quiz.</li>
            ...
            <li>Ranks can be viewed on the real time leader board. The leader board is updated every time a submission is made.</li>
            <li>Remember, once the timer starts, it can't be paused. It is a race against time. </li>
            <li>You'll only be considered for the leaderboard if you've registered.</li>
