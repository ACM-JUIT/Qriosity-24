...
function AboutUs() {
  ...
  return (
    ...
    <div className="aboutUs bg-cover bg-center p-4 bg-gradient-to-r from-gray-800 to-gray-900 font-sans" style={{ backgroundImage: 'url("../../public/astroSpace.png")', backdropFilter: 'blur(64px)', backgroundRepeat: 'repeat' }}>
      <LandingNavbar />
      <div className='aboutUsInfo m-4 bg-gray-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 border border-gray-800 flex flex-col bg-white bg-opacity-60'>
        <h1 className='text-3xl font-bold my-8 mx-auto underline'> About Us </h1>
        <ul className='aboutUsData list-disc m-8'>
        <h2 className='text-2xl font-bold m-4 mx-auto'> About Qriosity 4.0 </h2>
        ...
        <br />
        <br />
        <h2 className='text-2xl font-bold m-4 mx-auto'> About ACM-JUIT </h2>
        <p className='text-xl p-1'>
